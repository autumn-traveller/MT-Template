...
As can be seen in the figure \ref{fig:sim_vs_em}, the latencies recorded on the testbed closely match those from the SCNE, which it was seeking to replicate.
